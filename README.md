...
The project covers EDA, missing-data handling, predictive modeling, business recommendations, and responsible/agentic AI considerations within the Geldium case study.
...
The analysis includes missing values in important financial fields, making data-quality assessment and imputation an important part of the analysis.
...
The EDA identifies **credit utilization, missed payments and debt-to-income ratio** as important risk indicators.
...
The predictive modeling task uses **Logistic Regression** to estimate the likelihood of a customer becoming delinquent.
...
The analysis includes several important delinquency-risk patterns:
